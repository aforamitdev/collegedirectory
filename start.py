from flask import Flask,render_template,request,redirect,url_for,session,logging,request,flash,jsonify
...
class RegisterForm(Form):
    ...
    password = PasswordField("password", [validators.DataRequired(),validators.EqualTo('confirm', message="no match")])
